# GREB_v2 Register Map

Source: `common/command_interpreter/rtl/GREB_v2_commands_package.vhd`
...
|---------|------|--------|-------------|
| `0x000000` | `read_schema_cmd` | R | Register schema constant (`0x00000001`) |
...
In dual-sequencer targets, `addr[13:12]` selects the sequencer instance.
...
| `0x401101` | `ccd_1_rd_thresh_read_cmd` | R | CCD1 reset drain threshold |
| `0x401105` | `ccd_1_od_thresh_read_cmd` | R | CCD1 output drain threshold |
| `0x401110` | `ccd_2_gd_thresh_read_cmd` | R | CCD2 guard drain threshold |
| `0x401111` | `ccd_2_rd_thresh_read_cmd` | R | CCD2 reset drain threshold |
| `0x401115` | `ccd_2_od_thresh_read_cmd` | R | CCD2 output drain threshold |
