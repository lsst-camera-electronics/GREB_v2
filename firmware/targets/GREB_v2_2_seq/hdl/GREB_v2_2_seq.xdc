...
### 2023-11-06 jgt It appears that the order of
###                the sensors as installed per LCA-13381
###                is the opposite of the slice labels in
###                the schematic and layout of the GREB.
###                That is why the names are being flipped
###                in this file.
#### signals for CCD 1 ####
#CCD1 ADC (Bank 13)
set_property PACKAGE_PIN K26 [get_ports {adc_data_ccd_2[0]}]
set_property PACKAGE_PIN P26 [get_ports {adc_data_ccd_2[1]}]
set_property PACKAGE_PIN L25 [get_ports {adc_data_ccd_2[2]}]
set_property PACKAGE_PIN N24 [get_ports {adc_data_ccd_2[3]}]
set_property PACKAGE_PIN M26 [get_ports {adc_data_ccd_2[4]}]
set_property PACKAGE_PIN P25 [get_ports {adc_data_ccd_2[5]}]
set_property PACKAGE_PIN M20 [get_ports {adc_data_ccd_2[6]}]
set_property PACKAGE_PIN L24 [get_ports {adc_data_ccd_2[7]}]
set_property PACKAGE_PIN R26 [get_ports {adc_data_ccd_2[8]}]
set_property PACKAGE_PIN M25 [get_ports {adc_data_ccd_2[9]}]
set_property PACKAGE_PIN P24 [get_ports {adc_data_ccd_2[10]}]
set_property PACKAGE_PIN N26 [get_ports {adc_data_ccd_2[11]}]
set_property PACKAGE_PIN R25 [get_ports {adc_data_ccd_2[12]}]
set_property PACKAGE_PIN N19 [get_ports {adc_data_ccd_2[13]}]
set_property PACKAGE_PIN M24 [get_ports {adc_data_ccd_2[14]}]
set_property PACKAGE_PIN P19 [get_ports {adc_data_ccd_2[15]}]
set_property PACKAGE_PIN N16 [get_ports adc_cnv_ccd_2]
set_property PACKAGE_PIN K25 [get_ports adc_sck_ccd_2]

#(Bank 13)
set_property PACKAGE_PIN N22 [get_ports adc_buff_pd_ccd_2]

#ASPIC signals (Bank 32)
set_property PACKAGE_PIN Y15 [get_ports ASPIC_r_up_ccd_2_p]
set_property PACKAGE_PIN Y16 [get_ports ASPIC_r_up_ccd_2_n]
set_property PACKAGE_PIN AB14 [get_ports ASPIC_r_down_ccd_2_p]
set_property PACKAGE_PIN AB15 [get_ports ASPIC_r_down_ccd_2_n]
set_property PACKAGE_PIN AC19 [get_ports ASPIC_clamp_ccd_2_p]
set_property PACKAGE_PIN AD19 [get_ports ASPIC_clamp_ccd_2_n]
set_property PACKAGE_PIN AA17 [get_ports ASPIC_reset_ccd_2_p]
set_property PACKAGE_PIN AA18 [get_ports ASPIC_reset_ccd_2_n]

#CCD Clocks signals (Bank 32)
#parallels
set_property PACKAGE_PIN AC14 [get_ports {par_clk_ccd_2_p[0]}]
set_property PACKAGE_PIN AD14 [get_ports {par_clk_ccd_2_n[0]}]
set_property PACKAGE_PIN AA14 [get_ports {par_clk_ccd_2_p[1]}]
set_property PACKAGE_PIN AA15 [get_ports {par_clk_ccd_2_n[1]}]
set_property PACKAGE_PIN AD16 [get_ports {par_clk_ccd_2_p[2]}]
set_property PACKAGE_PIN AE16 [get_ports {par_clk_ccd_2_n[2]}]
set_property PACKAGE_PIN AF19 [get_ports {par_clk_ccd_2_p[3]}]
set_property PACKAGE_PIN AF20 [get_ports {par_clk_ccd_2_n[3]}]
#serials
set_property PACKAGE_PIN AD15 [get_ports {ser_clk_ccd_2_p[0]}]
set_property PACKAGE_PIN AE15 [get_ports {ser_clk_ccd_2_n[0]}]
set_property PACKAGE_PIN AE18 [get_ports {ser_clk_ccd_2_p[1]}]
set_property PACKAGE_PIN AF18 [get_ports {ser_clk_ccd_2_n[1]}]
set_property PACKAGE_PIN AF14 [get_ports {ser_clk_ccd_2_p[2]}]
set_property PACKAGE_PIN AF15 [get_ports {ser_clk_ccd_2_n[2]}]
set_property PACKAGE_PIN AE17 [get_ports reset_gate_ccd_2_p]
set_property PACKAGE_PIN AF17 [get_ports reset_gate_ccd_2_n]

# ASICs SPI control signals
#ASPIC signals  (Bank 13)
set_property PACKAGE_PIN M22 [get_ports ASPIC_spi_mosi_ccd_2]
set_property PACKAGE_PIN R23 [get_ports ASPIC_spi_sclk_ccd_2]
set_property PACKAGE_PIN M21 [get_ports ASPIC_spi_miso_t_ccd_2]
set_property PACKAGE_PIN P20 [get_ports ASPIC_spi_miso_b_ccd_2]
set_property PACKAGE_PIN T25 [get_ports ASPIC_ss_t_ccd_2]
set_property PACKAGE_PIN T20 [get_ports ASPIC_ss_b_ccd_2]
set_property PACKAGE_PIN T24 [get_ports ASPIC_spi_reset_ccd_2]
set_property PACKAGE_PIN R22 [get_ports ASPIC_nap_ccd_2]


##### CCD 2 #####

#CCD 2 ADC (Bank 15)
set_property PACKAGE_PIN B16 [get_ports {adc_data_ccd_1[0]}]
set_property PACKAGE_PIN A19 [get_ports {adc_data_ccd_1[1]}]
set_property PACKAGE_PIN A17 [get_ports {adc_data_ccd_1[2]}]
set_property PACKAGE_PIN B19 [get_ports {adc_data_ccd_1[3]}]
set_property PACKAGE_PIN C18 [get_ports {adc_data_ccd_1[4]}]
set_property PACKAGE_PIN D16 [get_ports {adc_data_ccd_1[5]}]
set_property PACKAGE_PIN G16 [get_ports {adc_data_ccd_1[6]}]
set_property PACKAGE_PIN F15 [get_ports {adc_data_ccd_1[7]}]
set_property PACKAGE_PIN A18 [get_ports {adc_data_ccd_1[8]}]
set_property PACKAGE_PIN B17 [get_ports {adc_data_ccd_1[9]}]
set_property PACKAGE_PIN C19 [get_ports {adc_data_ccd_1[10]}]
set_property PACKAGE_PIN C17 [get_ports {adc_data_ccd_1[11]}]
set_property PACKAGE_PIN D15 [get_ports {adc_data_ccd_1[12]}]
set_property PACKAGE_PIN H16 [get_ports {adc_data_ccd_1[13]}]
set_property PACKAGE_PIN G15 [get_ports {adc_data_ccd_1[14]}]
set_property PACKAGE_PIN J15 [get_ports {adc_data_ccd_1[15]}]
set_property PACKAGE_PIN K15 [get_ports adc_cnv_ccd_1]
set_property PACKAGE_PIN C16 [get_ports adc_sck_ccd_1]

#(Bank 13)
set_property PACKAGE_PIN R21 [get_ports adc_buff_pd_ccd_1]

#ASPIC signals (Bank 33)
set_property PACKAGE_PIN AB7  [get_ports ASPIC_r_up_ccd_1_p]
set_property PACKAGE_PIN AC7  [get_ports ASPIC_r_up_ccd_1_n]
set_property PACKAGE_PIN AA9  [get_ports ASPIC_r_down_ccd_1_p]
set_property PACKAGE_PIN AB9  [get_ports ASPIC_r_down_ccd_1_n]
set_property PACKAGE_PIN AB11 [get_ports ASPIC_clamp_ccd_1_p]
set_property PACKAGE_PIN AC11 [get_ports ASPIC_clamp_ccd_1_n]
set_property PACKAGE_PIN AC9  [get_ports ASPIC_reset_ccd_1_p]
set_property PACKAGE_PIN AD9  [get_ports ASPIC_reset_ccd_1_n]

#CCD Clocks signals (Bank 33)
#paralles
set_property PACKAGE_PIN AC8 [get_ports {par_clk_ccd_1_p[0]}]
set_property PACKAGE_PIN AD8 [get_ports {par_clk_ccd_1_n[0]}]
set_property PACKAGE_PIN AA8 [get_ports {par_clk_ccd_1_p[1]}]
set_property PACKAGE_PIN AA7 [get_ports {par_clk_ccd_1_n[1]}]
set_property PACKAGE_PIN AE7 [get_ports {par_clk_ccd_1_p[2]}]
set_property PACKAGE_PIN AF7 [get_ports {par_clk_ccd_1_n[2]}]
set_property PACKAGE_PIN V9  [get_ports {par_clk_ccd_1_p[3]}]
set_property PACKAGE_PIN W8  [get_ports {par_clk_ccd_1_n[3]}]
#serials
set_property PACKAGE_PIN Y11 [get_ports {ser_clk_ccd_1_p[0]}]
set_property PACKAGE_PIN Y10 [get_ports {ser_clk_ccd_1_n[0]}]
set_property PACKAGE_PIN Y8  [get_ports {ser_clk_ccd_1_p[1]}]
set_property PACKAGE_PIN Y7  [get_ports {ser_clk_ccd_1_n[1]}]
set_property PACKAGE_PIN W10 [get_ports {ser_clk_ccd_1_p[2]}]
set_property PACKAGE_PIN W9  [get_ports {ser_clk_ccd_1_n[2]}]
set_property PACKAGE_PIN V8  [get_ports reset_gate_ccd_1_p]
set_property PACKAGE_PIN V7  [get_ports reset_gate_ccd_1_n]

# ASICs SPI control signals
#ASPIC signals  (Bank )
set_property PACKAGE_PIN E16 [get_ports ASPIC_spi_mosi_ccd_1]
set_property PACKAGE_PIN N17 [get_ports ASPIC_spi_sclk_ccd_1]
set_property PACKAGE_PIN G17 [get_ports ASPIC_spi_miso_t_ccd_1]
set_property PACKAGE_PIN F18 [get_ports ASPIC_spi_miso_b_ccd_1]
set_property PACKAGE_PIN D19 [get_ports ASPIC_ss_t_ccd_1]
set_property PACKAGE_PIN D20 [get_ports ASPIC_ss_b_ccd_1]
set_property PACKAGE_PIN H18 [get_ports ASPIC_spi_reset_ccd_1]
set_property PACKAGE_PIN H17 [get_ports ASPIC_nap_ccd_1]
...
#(Bank32)
set_property PACKAGE_PIN AB17 [get_ports pulse_ccd_2_p]
set_property PACKAGE_PIN AC17 [get_ports pulse_ccd_2_n]
set_property PACKAGE_PIN AB12 [get_ports pulse_ccd_1_p]
set_property PACKAGE_PIN AC12 [get_ports pulse_ccd_1_n]
...
set_property PACKAGE_PIN R20 [get_ports Temp_adc_scl_ccd_2]
set_property PACKAGE_PIN T22 [get_ports Temp_adc_sda_ccd_2]
# ccd2 temp probes (Bank 15)
set_property PACKAGE_PIN K18 [get_ports Temp_adc_scl_ccd_1]
set_property PACKAGE_PIN M16 [get_ports Temp_adc_sda_ccd_1]
...
set_property PACKAGE_PIN AE22 [get_ports aspic_t_v_ss_ccd2]
set_property PACKAGE_PIN AF22 [get_ports aspic_t_v_ss_ccd1]
...
##clock rails DAC (Bank 14)
set_property PACKAGE_PIN J25 [get_ports sync_ccd2_C_BIAS]
set_property PACKAGE_PIN L22 [get_ports sync_ccd1_C_BIAS]
...
set_property PACKAGE_PIN T18  [get_ports ccd2_adc_EOC]
set_property PACKAGE_PIN L18  [get_ports ccd1_adc_EOC]
...
set_property PACKAGE_PIN U19  [get_ports ccd2_adc_CS]
set_property PACKAGE_PIN K17  [get_ports ccd1_adc_CS]
...
set_property PACKAGE_PIN U20  [get_ports ccd2_adc_CONVST]
set_property PACKAGE_PIN M17  [get_ports ccd1_adc_CONVST]
set_property PACKAGE_PIN AA23 [get_ports ck_adc_SHDN]
set_property PACKAGE_PIN T19  [get_ports ccd2_adc_SHDN]
set_property PACKAGE_PIN L17  [get_ports ccd1_adc_SHDN]
...
set_property PACKAGE_PIN Y17  [get_ports ccd2_clk_en_out_p]
set_property IOSTANDARD LVDS [get_ports  ccd2_clk_en_out_p]
set_property PACKAGE_PIN Y18  [get_ports ccd2_clk_en_out_n]
set_property IOSTANDARD LVDS [get_ports  ccd2_clk_en_out_n]
set_property PACKAGE_PIN AD11 [get_ports ccd1_clk_en_out_p]
set_property IOSTANDARD LVDS [get_ports  ccd1_clk_en_out_p]
set_property PACKAGE_PIN AE11 [get_ports ccd1_clk_en_out_n]
set_property IOSTANDARD LVDS [get_ports  ccd1_clk_en_out_n]

#ASPIC reference enable (Bank 14)
set_property PACKAGE_PIN D24 [get_ports ASPIC_ref_sd_ccd2]

#ASPIC 5V enable 
set_property PACKAGE_PIN E23 [get_ports ASPIC_5V_sd_ccd2]

#ASPIC reference enable (Bank 14)
set_property PACKAGE_PIN E25 [get_ports ASPIC_ref_sd_ccd1]

#ASPIC 5V enable 
set_property PACKAGE_PIN D25 [get_ports ASPIC_5V_sd_ccd1]
