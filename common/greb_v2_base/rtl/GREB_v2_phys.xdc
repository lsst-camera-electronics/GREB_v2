...
#CCD 2 ADC (Bank 15)
set_property PACKAGE_PIN B16 [get_ports {adc_data_ccd[1][0]}]
set_property PACKAGE_PIN A19 [get_ports {adc_data_ccd[1][1]}]
set_property PACKAGE_PIN A17 [get_ports {adc_data_ccd[1][2]}]
set_property PACKAGE_PIN B19 [get_ports {adc_data_ccd[1][3]}]
set_property PACKAGE_PIN C18 [get_ports {adc_data_ccd[1][4]}]
set_property PACKAGE_PIN D16 [get_ports {adc_data_ccd[1][5]}]
set_property PACKAGE_PIN G16 [get_ports {adc_data_ccd[1][6]}]
set_property PACKAGE_PIN F15 [get_ports {adc_data_ccd[1][7]}]
set_property PACKAGE_PIN A18 [get_ports {adc_data_ccd[1][8]}]
set_property PACKAGE_PIN B17 [get_ports {adc_data_ccd[1][9]}]
set_property PACKAGE_PIN C19 [get_ports {adc_data_ccd[1][10]}]
set_property PACKAGE_PIN C17 [get_ports {adc_data_ccd[1][11]}]
set_property PACKAGE_PIN D15 [get_ports {adc_data_ccd[1][12]}]
set_property PACKAGE_PIN H16 [get_ports {adc_data_ccd[1][13]}]
set_property PACKAGE_PIN G15 [get_ports {adc_data_ccd[1][14]}]
set_property PACKAGE_PIN J15 [get_ports {adc_data_ccd[1][15]}]
set_property PACKAGE_PIN K15 [get_ports {adc_cnv_ccd[1]}]
set_property PACKAGE_PIN C16 [get_ports {adc_sck_ccd[1]}]

#(Bank 13)
set_property PACKAGE_PIN R21 [get_ports {adc_buff_pd_ccd[1]}]
...
set_property PACKAGE_PIN AB11 [get_ports {ASPIC_clamp_ccd_p[1]}]
set_property PACKAGE_PIN AC11 [get_ports {ASPIC_clamp_ccd_n[1]}]
set_property PACKAGE_PIN AC9 [get_ports {ASPIC_reset_ccd_p[1]}]
set_property PACKAGE_PIN AD9 [get_ports {ASPIC_reset_ccd_n[1]}]

#CCD Clocks signals (Bank 33)
#paralles
set_property PACKAGE_PIN AC8 [get_ports {par_clk_ccd_p[1][0]}]
set_property PACKAGE_PIN AD8 [get_ports {par_clk_ccd_n[1][0]}]
set_property PACKAGE_PIN AA8 [get_ports {par_clk_ccd_p[1][1]}]
set_property PACKAGE_PIN AA7 [get_ports {par_clk_ccd_n[1][1]}]
set_property PACKAGE_PIN AE7 [get_ports {par_clk_ccd_p[1][2]}]
set_property PACKAGE_PIN AF7 [get_ports {par_clk_ccd_n[1][2]}]
set_property PACKAGE_PIN V9 [get_ports {par_clk_ccd_p[1][3]}]
set_property PACKAGE_PIN W8 [get_ports {par_clk_ccd_n[1][3]}]
#serials
set_property PACKAGE_PIN Y11 [get_ports {ser_clk_ccd_p[1][0]}]
set_property PACKAGE_PIN Y10 [get_ports {ser_clk_ccd_n[1][0]}]
set_property PACKAGE_PIN Y8 [get_ports {ser_clk_ccd_p[1][1]}]
set_property PACKAGE_PIN Y7 [get_ports {ser_clk_ccd_n[1][1]}]
set_property PACKAGE_PIN W10 [get_ports {ser_clk_ccd_p[1][2]}]
set_property PACKAGE_PIN W9 [get_ports {ser_clk_ccd_n[1][2]}]
set_property PACKAGE_PIN V8 [get_ports {reset_gate_ccd_p[1]}]
set_property PACKAGE_PIN V7 [get_ports {reset_gate_ccd_n[1]}]

# ASICs SPI control signals
#ASPIC signals  (Bank )
set_property PACKAGE_PIN E16 [get_ports {ASPIC_spi_mosi_ccd[1]}]
set_property PACKAGE_PIN N17 [get_ports {ASPIC_spi_sclk_ccd[1]}]
set_property PACKAGE_PIN G17 [get_ports {ASPIC_spi_miso_t_ccd[1]}]
set_property PACKAGE_PIN F18 [get_ports {ASPIC_spi_miso_b_ccd[1]}]
...
set_property PACKAGE_PIN AB12 [get_ports {pulse_ccd_p[1]}]
set_property PACKAGE_PIN AC12 [get_ports {pulse_ccd_n[1]}]
...
set_property PACKAGE_PIN K18 [get_ports {Temp_adc_scl_ccd[1]}]
set_property PACKAGE_PIN M16 [get_ports {Temp_adc_sda_ccd[1]}]
...
set_property PACKAGE_PIN AF22 [get_ports {aspic_t_v_ss_ccd[1]}]
...
set_property PACKAGE_PIN L22 [get_ports {sync_C_BIAS[1]}]
...
set_property PACKAGE_PIN L18 [get_ports {ccd_adc_EOC[1]}]
...
set_property PACKAGE_PIN K17 [get_ports {ccd_adc_CS[1]}]
...
set_property PACKAGE_PIN M17 [get_ports {ccd_adc_CONVST[1]}]
set_property PACKAGE_PIN AA23 [get_ports ck_adc_SHDN]
set_property PACKAGE_PIN T19 [get_ports {ccd_adc_SHDN[0]}]
set_property PACKAGE_PIN L17 [get_ports {ccd_adc_SHDN[1]}]
...
set_property IOSTANDARD LVDS [get_ports {ccd_clk_en_out_p[1]}]
set_property PACKAGE_PIN AD11 [get_ports {ccd_clk_en_out_p[1]}]
set_property PACKAGE_PIN AE11 [get_ports {ccd_clk_en_out_n[1]}]
set_property IOSTANDARD LVDS [get_ports {ccd_clk_en_out_n[1]}]
...
#ASPIC reference enable (Bank 14)
set_property PACKAGE_PIN E25 [get_ports {ASPIC_ref_sd_ccd[1]}]

#ASPIC 5V enable
set_property PACKAGE_PIN D25 [get_ports {ASPIC_5V_sd_ccd[1]}]
...
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_down_ccd_n[1]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_down_ccd_n[0]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_down_ccd_p[1]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_down_ccd_p[0]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_up_ccd_n[1]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_up_ccd_n[0]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_up_ccd_p[1]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_r_up_ccd_p[0]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_reset_ccd_n[1]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_reset_ccd_n[0]}]
set_property IOSTANDARD LVDS [get_ports {ASPIC_reset_ccd_p[1]}]
